...
![image-20241021102353200](../../assets/Day04-攻击/image-20241021102353200.png)
...
7.   连接关系:
     ...
     <img src="../../assets/Day04-攻击/image-20241021105111493.png" alt="image-20241021105111493" style="zoom:50%;" />
...
12.   设置事件回调函数
      ...
      <img src="../../assets/Day04-攻击/image-20241021122236855.png" alt="image-20241021122236855" style="zoom:67%;" />
...
<img src="../../assets/Day04-攻击/image-20241021125154384.png" alt="image-20241021125154384" style="zoom:50%;" />
...
2.   勾选isTrigger触发器
     ...
     <img src="../../assets/Day04-攻击/image-20241021125800462.png" alt="image-20241021125800462" style="zoom:50%;" />

3.   用剑影来判断范围碰撞体范围

     <img src="../../assets/Day04-攻击/image-20241021125919717.png" alt="image-20241021125919717" style="zoom:50%;" />

4.   在这有剑影的一帧里, 启动/关闭这个碰撞体, 进行判定

     <img src="../../assets/Day04-攻击/image-20241021130543842.png" alt="image-20241021130543842" style="zoom:50%;" />

     Animation->Add Property->Attack Area->Attack1->Game Object is Active 在这一帧里启动这个物体

     <img src="../../assets/Day04-攻击/image-20241021130632144.png" alt="image-20241021130632144" style="zoom:50%;" />
...
7.   为了防止伤到玩家自己, 为Attack override Layers
     ...
     <img src="../../assets/Day04-攻击/image-20241021133223950.png" alt="image-20241021133223950" style="zoom:50%;" />
...
9.   此时, 敌人不会扣血, Why?
     ...
     **两个碰撞体都有LayerOverride**
     ...
     <img src="../../assets/Day04-攻击/image-20241021155702989.png" alt="image-20241021155702989" style="zoom:50%;" />
     ...
     <img src="../../assets/Day04-攻击/image-20241021155940549.png" alt="image-20241021155940549" style="zoom:50%;" />
