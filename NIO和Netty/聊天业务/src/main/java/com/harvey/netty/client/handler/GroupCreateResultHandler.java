...
import com.harvey.netty.message.GroupCreateResponseMessage;
...
public class GroupCreateResultHandler extends SimpleChannelInboundHandler<GroupCreateResponseMessage> {
    @Override
