...
![image-20250920185312744](../../assetss/Day10-Service/image-20250920185312744.png)

进入创建页面

![image-20250920185403498](../../assetss/Day10-Service/image-20250920185403498.png)
...
![image-20250920191344402](../../assetss/Day10-Service/image-20250920191344402.png)

再次按下Start, `onStart()`方法没有反复执行, 只执行了`onStartCommand()`方法

![image-20250920191403017](../../assetss/Day10-Service/image-20250920191403017.png)

按下Stop

![image-20250920191419876](../../assetss/Day10-Service/image-20250920191419876.png)

再次start

![image-20250920191724660](../../assetss/Day10-Service/image-20250920191724660.png)
...
![image-20250920192724658](../../assetss/Day10-Service/image-20250920192724658.png)
...
![image-20250920201132046](../../assetss/Day10-Service/image-20250920201132046.png)

多次点击bind, 并不会多次onBind, 也不会多次connect

手动start了Service之后再bind, 则不会重复create, 但由于是手动start的Service, 因此必定调用onCommandService

![image-20250920201334037](../../assetss/Day10-Service/image-20250920201334037.png)



点击一次unbind, 正常unbind了, 调用了Service的destory方法(但没有disconnect)

![image-20250920200348495](../../assetss/Day10-Service/image-20250920200348495.png)

unbind之后再次bind, service重新创建, onBind方法重新调用, connection重新链接

![image-20250920200436920](../../assetss/Day10-Service/image-20250920200436920.png)
...
![img](../../assetss/Day10-Service/service_binding_tree_lifecycle.png)
