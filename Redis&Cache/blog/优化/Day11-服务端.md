...
2.  建议关闭RDB, 使用AOF持久化
    ...
    -   配置`no-appendfsync-on-rewrite = yes`, 禁止在`rewrite`或`fork`期间aof, 避免AOF引起的阻塞
        ...
        ![image-20240220171941152](../../assets/Day11-%E6%9C%8D%E5%8A%A1%E7%AB%AF/image-20240220171941152.png)
...
![image-20240220203154154](../../assets/Day11-%E6%9C%8D%E5%8A%A1%E7%AB%AF/image-20240220203154154.png)
