...
![image-20231021165532718](../../shoot/Day07-使用InnoDB的索引/image-20231021165532718.png)
...
-   这里如果使用多个字段时(以Unique为例)
    ...
    -   例如name和phone为联合索引,phone唯一,name不唯一,依旧可以选择unique
        ...
        ![image-20231026163353147](../../shoot/Day07-InnoDB索引增删查/image-20231026163353147.png)

        -   但是,如果一个字段没有被约束成Unique,但数据实质上是Unique的,那么可以创建,不会报错

        -   但是,创建了Unique索引之后,就会检查唯一性,就会报错了

            ![image-20231026163707628](../../shoot/Day07-InnoDB索引增删查/image-20231026163707628.png)
-   创建索引的顺序的讲究
