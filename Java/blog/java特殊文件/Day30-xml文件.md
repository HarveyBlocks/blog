...
- 不要乱在xml文件里写>,<,&啥的(><会被认定是标签)
  - 平替:![image-20231004004846059](../../typora-user-images/Day30/image-20231004004846059.png)
  - 可以用浏览器查看是否替换成功:
    - xml文件里的样子:<img src="../../typora-user-images/Day30/image-20231004005029309.png" alt="image-20231004005029309" style="zoom: 50%;" />
    - ​												↓
    - 浏览器里的样子:<img src="../../typora-user-images/Day30/image-20231004005058669.png" alt="image-20231004005058669" style="zoom:50%;" />

  - 也可以输入"CD"一回车![image-20231004005522775](../../typora-user-images/Day30/image-20231004005522775.png)
  - 召唤出特殊数据区:![image-20231004005636626](../../typora-user-images/Day30/image-20231004005636626.png)
...
![image-20231004144127769](../../typora-user-images/Day31/image-20231004144127769.png)
...
- Dom4j框架**解析XML文档,获取Document对象**常用API:
  ...
  ![image-20231004144243331](../../typora-user-images/Day31/image-20231004144243331.png)
...
![a](../../typora-user-images/Day31/image-20231004150648774.png)
...
![image-20231004160651541](../../typora-user-images/Day31/image-20231004160651541.png)

![image-20231004160730603](../../typora-user-images/Day31/image-20231004160730603.png)
...
- 后缀必须是.xsd
  ...
  ![image-20231004163619730](../../typora-user-images/Day31/image-20231004163619730.png)

  ![image-20231004163530192](../../typora-user-images/Day31/image-20231004163530192.png)

  

  约束后的正确格式:

  ![image-20231004163722984](../../typora-user-images/Day31/image-20231004163722984.png)
