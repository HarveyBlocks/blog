...
- 不要乱在xml文件里写>,<,&啥的(><会被认定是标签)
  - 平替:![image-20231004004846059](../../assets/Day30/image-20231004004846059.png)
  - 可以用浏览器查看是否替换成功:
  ...
  - 也可以输入"CD"一回车![image-20231004005522775](../../assets/Day30/image-20231004005522775.png)
  - 召唤出特殊数据区:![image-20231004005636626](../../assets/Day30/image-20231004005636626.png)
...
![image-20231004144127769](../../assets/Day31/image-20231004144127769.png)
...
- Dom4j框架**解析XML文档,获取Document对象**常用API:
  ...
  ![image-20231004144243331](../../assets/Day31/image-20231004144243331.png)
...
![a](../../assets/Day31/image-20231004150648774.png)
...
![image-20231004160651541](../../assets/Day31/image-20231004160651541.png)

![image-20231004160730603](../../assets/Day31/image-20231004160730603.png)
...
- 后缀必须是.dtd
  ...
  ![image-20231004162355349](../../assets/Day31/image-20231004162355349.png)
  
### Schema约束文档

- 后缀必须是.xsd

  ![image-20231004163619730](../../assets/Day31/image-20231004163619730.png)

  ![image-20231004163530192](../../assets/Day31/image-20231004163530192.png)

  

  约束后的正确格式:

  ![image-20231004163722984](../../assets/Day31/image-20231004163722984.png)
