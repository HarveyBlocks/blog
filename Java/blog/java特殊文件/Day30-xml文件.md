...
- 不要乱在xml文件里写>,<,&啥的(><会被认定是标签)
  ...
  - 可以用浏览器查看是否替换成功:
    - xml文件里的样子:<img src="../../assets/Day30/image-20231004005029309.png" alt="image-20231004005029309" style="zoom: 50%;" />
    - ​												↓
    - 浏览器里的样子:<img src="../../assets/Day30/image-20231004005058669.png" alt="image-20231004005058669" style="zoom:50%;" />
