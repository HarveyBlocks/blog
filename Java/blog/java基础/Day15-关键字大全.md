...
- **区分"子类对象访问",如果在非子类实例化了一个子类对象,用  <子类对象. 方法>调用protect修饰的方法,就这就不行了!**
...
| finally        | 用在异常处理中，在抛出异常后必做的过程，常用于释放资源 |
| throw          | 抛出一个异常                                           |
