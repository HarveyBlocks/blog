...
![image-20240520204000259](../asset/Day16-G1/image-20240520204000259.png)
...
![image-20240602225815782](../asset/Day16-G1/image-20240602225815782.png)
...
-   如果产生了跨代引用(老年代引用年轻代), 此时这个Region对应的卡表上就会将字节内容进行修改, JDK8源码中0代表引用了, 称为脏卡
    ...
    ![image-20240602231652098](../asset/Day16-G1/image-20240602231652098.png)
