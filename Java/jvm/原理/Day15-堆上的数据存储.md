...
-   每个属性偏移量Offset(字段地址-起始地址)必须是字段长度的N倍?????????
    ...
    ![image-20240601231014616](../assets/Day15-堆上的数据存储/image-20240601231014616.png)

-   引用数据类型一定要在基本数据类型之后

-   综上两点要同时实现, 就有可能出现不只是在对象最后有对齐, 也有可能在中间也有对齐

    ![image-20240601231324467](../assets/Day15-堆上的数据存储/image-20240601231324467.png)
...
![image-20240601231829654](../assets/Day15-堆上的数据存储/image-20240601231829654.png)
...
![image-20240601204226570](../assets/Day15-堆上的数据存储/image-20240601204226570.png)

以64位关闭指针压缩为例

![image-20240601211932840](../assets/Day15-堆上的数据存储/image-20240601211932840.png)
